  ...
  return (
    <div className="-mt-25 w-full h-245 bg-white -z-10">
        ...
        <div>
          ...
          >
            <SwiperSlide className="flex! justify-end! w-full h-140 bg-[url('/SDBackground.png')]! bg-no-repeat! bg-top! bg-[length:100%_auto]!">
              <div className="flex flex-col p-6.25 w-81 h-115 bg-[linear-gradient(130deg,rgba(81,214,255,1)_0%,rgba(34,127,248,1)_100%)]">
                ...
                <h1 className="text-white text-5xl self-start">구조부</h1>
              </div>
            </SwiperSlide>
            <SwiperSlide className="flex! justify-end! w-full h-140 bg-[url('/SDBackground.png')]! bg-no-repeat! bg-top! bg-[length:100%_auto]!">
              <div className="flex flex-col p-6.25 w-81 h-115 bg-[linear-gradient(130deg,rgba(81,214,255,1)_0%,rgba(34,127,248,1)_100%)]">
...
//             <div
//             onClick={() => {
//               selectedIndex > 1 ? swiperRef.current?.slideTo(2, 500) : swiperRef.current?.slideTo(0, 500);
//               selectedIndex > 1 ? setSelectedIndex(2) : setSelectedIndex(0);
//             }}
//             className="w-22.5  flex flex-col items-center">
//               <SDLogo scale={90} color={selectedIndex % 2 === 0 ? "#2159B7" : "#A1A1A1"} />
//               <p className={`mt-1 text-center text-xl ${selectedIndex === 0 ? "text-[#2159B7]" : "text-black"}`}>구조부</p>
//             </div>
//             <div
//             onClick={() => {
//               selectedIndex > 1 ? swiperRef.current?.slideTo(3, 500) : swiperRef.current?.slideTo(1, 500);
//               selectedIndex > 1 ? setSelectedIndex(3) : setSelectedIndex(1);
//             }}
//             className="w-22.5  flex flex-col items-center">
//               <MOWRLogo scale={90} color={selectedIndex % 2 === 1 ? "#2159B7" : "#A1A1A1"} />
//               <p className={`mt-1 text-center text-xl ${selectedIndex % 2 === 1 ? "text-[#2159B7]" : "text-black"}`}>수자원부</p>
//             </div>
//           </div>
//         </div>
...
//             loop={true}
//             onSwiper={(swiper) => (swiperRef.current = swiper)}
//             onSlideChangeTransitionStart={() => {setSelectedIndex(swiperRef.current?.realIndex ?? 0); console.log(swiperRef.current?.realIndex)}}
//           >
//             <SwiperSlide className="flex! justify-end! w-full h-140 bg-[url('/SDBackground.png')]! bg-no-repeat! bg-top! bg-[length:100%_auto]!">
//               <div className="flex flex-col p-6.25 w-81 h-115 bg-[linear-gradient(130deg,rgba(81,214,255,1)_0%,rgba(34,127,248,1)_100%)]">
//                 <div className="w-25 h-25 self-end mb-6">
